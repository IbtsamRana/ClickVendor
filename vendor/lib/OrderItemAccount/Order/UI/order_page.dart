      ...
      if (value.statusCode == 200) {
        if (value.body
          ...
          OrderImageBean orderImageBean =
              OrderImageBean.fromJson(jsonDecode(value.body));
                                ...
                                onTap: () {
                                  if (tabController.index == 2) {
                                    Navigator.pushNamed(context,
                                        PageRoutes.createOrderPageGrocery,
                                        arguments: {
                                          'orderdetails':
                                              orederImageList[index],
                                          'curency': curency,
                                        }).then((value) {
                                  ...
                                  child: ListTile(
                                    ...
                                    title: RichText(
                                      text: TextSpan(children: [
                                        TextSpan(
                                          text: (orederImageList[index]
                                                      .user_name !=
                                                  null)
                                              ? '${orederImageList[index].user_name}\n\n'
                                              : '\n\n',
                              ...
                              GestureDetector(
                                onTap: () {
                                  if (orederList[index].payment_method == null ||
                                      orederList[index].payment_status ==
                                          null ||
