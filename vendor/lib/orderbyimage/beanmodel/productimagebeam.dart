...
class PIVarient{
  ...
  factory PIVarient.fromJson(dynamic js){
    return PIVarient(js['varient_id'], js['product_id'], js['quantity'], js['unit'], js['price'], js['description'], js['varient_image']);
  }

  @override
  String toString() {
    return '{varient_id: $varient_id, product_id: $product_id, quantity: $quantity, unit: $unit, price: $price, description: $description, varient_image: $varient_image}';
  }
