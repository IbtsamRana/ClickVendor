var imageBaseUrl = "https://admin.clickapp.pk/GoMarket/";
...
var store_subcategoryall =
    Uri.parse(baseUrl + "store_subcategoryshow"); //vendor_id
var store_subcategoryproduct =
    Uri.parse(baseUrl + "store_subcategoryproduct"); //vendeo_id,subcat_id
var store_addnewvariant =
    Uri.parse(baseUrl + "store_addnewvariant"); //vendeo_id,subcat_id
var store_deleteproduct =
    Uri.parse(baseUrl + "store_deleteproduct"); //vendeo_id,subcat_id
var store_deletevariant =
    Uri.parse(baseUrl + "store_deletevariant"); //vendeo_id,subcat_id
var store_status = Uri.parse(baseUrl + "store_status"); //vendeo_id,subcat_id
var store_current_status =
    Uri.parse(baseUrl + "store_current_status"); //vendeo_id
...
var resturant_updateproductvariant =
    Uri.parse(baseUrl + "resturant_updateproductvariant");
...
var resturant_addaddons_update =
    Uri.parse(baseUrl + "resturant_addaddons_update");
var resturant_addnewproduct = Uri.parse(baseUrl + "resturant_addnewproduct");
var resturant_updatenewproduct =
    Uri.parse(baseUrl + "resturant_updatenewproduct");
...
var pharmacy_updatenewproduct =
    Uri.parse(baseUrl + "pharmacy_updatenewproduct");
...
var pharmacy_addaddons_update =
    Uri.parse(baseUrl + "pharmacy_addaddons_update");
